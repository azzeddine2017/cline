...
export const ar = {
  ...
  "common.customInstructionsPlaceholder": "مثال: \"قم بتشغيل اختبارات الوحدة في النهاية\"، \"استخدم TypeScript مع async/await\"، \"تحدث بالعربية\"",
  ...
  "common.separateModelsDescription": "سيؤدي التبديل بين وضعي التخطيط والتنفيذ إلى الاحتفاظ بواجهة برمجة التطبيقات والنموذج المستخدم في الوضع السابق. قد يكون هذا مفيدًا عند استخدام نموذج استدلال قوي لتصميم خطة لنموذج برمجة أرخص للعمل عليها.",
  "common.telemetry": "السماح بإرسال تقارير الأخطاء والاستخدام المجهولة",
  "common.telemetryDescription": "ساعد في تحسين كلاين من خلال إرسال بيانات استخدام مجهولة وتقارير أخطاء. لن يتم إرسال أي كود أو مطالبات أو معلومات شخصية أبدًا.",
  "common.planMode": "وضع التخطيط",
  "common.actMode": "وضع التنفيذ",

  // Welcome View
  "welcome.title": "مرحباً، أنا كلاين",
  "welcome.description": "يمكنني القيام بكل أنواع المهام بفضل التطورات في قدرات البرمجة الذاتية لـ Claude 3.7 Sonnet والوصول إلى الأدوات التي تتيح لي إنشاء وتعديل الملفات واستكشاف المشاريع المعقدة واستخدام المتصفح وتنفيذ أوامر الطرفية (بإذنك بالطبع). يمكنني حتى استخدام MCP لإنشاء أدوات جديدة وتوسيع قدراتي.",
  "welcome.getStarted": "البدء",

  // Home Header
  "home.whatCanIDo": "كيف يمكنني مساعدتك؟",
  "home.capabilities": "يمكنني تطوير البرمجيات خطوة بخطوة من خلال تعديل الملفات واستكشاف المشاريع وتشغيل الأوامر واستخدام المتصفحات. يمكنني حتى توسيع قدراتي باستخدام أدوات MCP للمساعدة بما يتجاوز إكمال الكود الأساسي.",
  ...
  // Prompts
  "prompt.default": "أنا مساعد ذكاء اصطناعي يُدعى كلاين. يمكنني مساعدتك في مهام البرمجة، والإجابة على الأسئلة، وتقديم المعلومات.",
