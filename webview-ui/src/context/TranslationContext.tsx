...
export const TranslationProvider: React.FC<TranslationProviderProps> = ({ children }) => {
	...
	useEffect(() => {
		if (chatSettings?.preferredLanguage) {
			...
			const languageKey = chatSettings.preferredLanguage.startsWith("Arabic") ? "ar" : "en"
	...
	return <TranslationContext.Provider value={{ language, setLanguage, t, isRtl }}>{children}</TranslationContext.Provider>
}
